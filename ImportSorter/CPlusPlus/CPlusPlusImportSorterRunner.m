...
@interface CPlusPlusImportSorterRunner ()
@property (nonatomic) CPlusPlusClassRole *classRole;
@end

@implementation CPlusPlusImportSorterRunner
#pragma mark - public methods

static NSString *const kImportDeclarationPrefix = @"#include ";
...
- (NSArray *)sortImportDeclarations:(NSArray *)originalImportDeclarations
{
    ...
    for (NSString *importDeclaration in originalImportDeclarations) {
        CPlusPlusImportClassRole importClassRole = [_classRole getImportClassRole:importDeclaration];
